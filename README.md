...
Adventure Trail Studio는 **비상업적 사용만 허용하는 소스 공개 라이선스**로 배포됩니다.

- 개인, 교육, 연구, 비영리 목적의 사용과 수정은 허용됩니다.
- 상업적 사용, 유료 서비스 제공, 판매, 재배포 목적의 사용은 별도 허가가 필요합니다.
- 상업적 사용이 필요한 경우 Design Arete에 별도 라이선스를 문의해야 합니다.
